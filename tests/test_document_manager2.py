...
class TestDocumentManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        for name in ['a1.pdf', 'a2.pdf', 'b.doc', 'c1.html', 'c2.png', 'c3.png', 'c1.pdf', 'c2.pdf', 'c3.pdf']:
    ...
    def test_find_document_by_id(self):
        ...
        c = Document('C', 'description of C', 1,
                     ['/tmp/edms/samples/c1.html', '/tmp/edms/samples/c2.png', '/tmp/edms/samples/c3.png'], 'html')
    ...
    def test_invalid_id(self):
        a = Document('title1', 'desc1', 1, ['/tmp/edms/samples/a1.pdf', '/tmp/edms/samples/a2.pdf'], 'pdf')
        a_id = self._document_manager.add_document(a)
        with self.assertRaises(ValueError):
    ...
    def test_find_documents_by_format(self):
        ...
        c = Document('C', 'description of A', 1,
                     ['/tmp/edms/samples/c1.pdf', '/tmp/edms/samples/c2.pdf', '/tmp/edms/samples/c3.pdf'], 'pdf')
        self._document_manager.add_document(a)
        self._document_manager.add_document(b)
