...
class TestUser(unittest.TestCase):
    ...
    def test_create_user(self):
        ...
        testuser = User(first_name, family_name, birth, email, "secret")
        self.assertTrue(testuser)
        self.assertEqual(testuser.family_name, family_name)
        self.assertEqual(testuser.first_name, first_name)
        self.assertEqual(testuser.birth, birth)
        self.assertEqual(testuser.email, email)
        self.assertEqual(testuser.password, "secret")
